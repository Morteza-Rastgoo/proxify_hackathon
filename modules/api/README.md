...
```mcp
__polytope__run(tool: api-add-postgres-client, args: {})
```
...
```mcp
__polytope__run(tool: api-add-couchbase-client, args: {})
```

Or if visible:

```mcp
__polytope__api-add-couchbase-client()
```
...
```mcp
__polytope__run(tool: api-add-couchbase-model, args: {name: "model-name"})
```

Or if visible:

```mcp
__polytope__api-add-couchbase-model(name: "model-name")
```
...
```mcp
__polytope__run(tool: api-add-twilio-client, args: {})
```
